...
def create_single_models():
    ...
    result = [
        ...
        astropy_models.Cosine1D(amplitude=10., frequency=0.5, phase=1.),
        astropy_models.Tangent1D(amplitude=10., frequency=0.5, phase=1.),
        astropy_models.ArcSine1D(amplitude=10., frequency=0.5, phase=1.),
        astropy_models.ArcCosine1D(amplitude=10., frequency=0.5, phase=1.),
        astropy_models.ArcTangent1D(amplitude=10., frequency=0.5, phase=1.),
